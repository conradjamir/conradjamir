...
function startAd() {
  ...
  //Define Variables
  let tlExpand = gsap.timeline(),
    container = document.getElementById("container"),
    contentDiv = document.getElementById("content"),
    player = document.getElementById("player"),
    expandBtn = document.getElementById("expandBtn"),
    closeBtn = document.getElementById("closeBtn"),
    clickTag = document.querySelectorAll(".clickTag"),
  ...
  function exitClickHandler() {
    if (isExpanded) {
      actionClickHandler();
      Enabler.exit("The creative has collapsed.");
    }
  ...
  function addListeners() {
    ...
    closeBtn.addEventListener('click', closeFullScreen, false);

    clickTag[0].addEventListener('click', exitClickHandler, false);
    clickTag[1].addEventListener('click', exitClickHandler, false);
  }

  //detect mobile & scale content to fit
  function mobileWindow() {
    ...
    // 568 is fixed width of content div
    scaleContent = windowWidth / 568;
