	...
	return (
		<section className="relative w-full mx-auto bg-black h-dvh z-2">
			...
			<div className="relative top-[30px] container flex flex-col-reverse py-20 justify-between px-4 mx-auto h-dvh scroll-mt-25 md:flex-row md:justify-between md:items-center z-3">
				<div className="flex items-center text-left md:items-end md:w-2/3 lg:w-3/4 md:h-dvh md:pb-25 md:text-left mobileLandscape:w-full mobileLandscape:text-right mobileLandscape:items-end mobileLandscape:h-dvh mobileLandscape:pb-0">
					<div>
						...
						<p className="text-lg text-white">
							Bringing brands to life through animation, code, and design — from digital ads to interactive web experiences.
						</p>
					</div>
				</div>
